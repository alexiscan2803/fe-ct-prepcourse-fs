...
console.log(obtenerMayor(5,6)) // devuelve 6
console.log(obtenerMayor(10,6)) // devuelve 10
...
console.log(conection(1)) // devuelve "Online"
console.log(conection(2)) // devuelve "Away"
console.log(conection(5)) // devuelve "Offline" 
...
console.log(operadoresLogicos(15, 10, 8))
console.log(operadoresLogicos(-10, 15, 23))
console.log(operadoresLogicos(10, -15, 23))
console.log(operadoresLogicos(10, 15, -23))
console.log(operadoresLogicos(10, 15, 23))
console.log(operadoresLogicos(0, 0, 0))
console.log(operadoresLogicos(10, 80, 23))
...
console.log(tieneTresDigitos(185))
console.log(tieneTresDigitos(5))
